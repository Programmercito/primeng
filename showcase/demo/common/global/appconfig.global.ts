...
export class AppConfigGlobal {
    readonly cBaseUrl: string = '/AppSeguridad-web';
    readonly cApiRest: string = '/api';
    readonly cHost: string = '';
    
    readonly cBaseUrl70: string = '/AppSeguridad-web';
